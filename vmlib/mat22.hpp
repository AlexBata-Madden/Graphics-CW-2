...
{
	return Mat22f{ ((aLeft._00 * aRight._00) + (aLeft._01 * aRight._10)), ((aLeft._00 * aRight._01) + (aLeft._01 * aRight._11)),
...
{
	return Vec2f{ ((aLeft._00 * aRight.x) + (aLeft._01 * aRight.y)),((aLeft._10 * aRight.x) + (aLeft._11 * aRight.y)) };
}
